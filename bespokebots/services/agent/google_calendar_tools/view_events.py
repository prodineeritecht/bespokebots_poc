...
class ViewEventsSchema(BaseModel):
    ...
    time_min: Optional[str] = Field(
        None,
        title="Time Min",
        description="The start time of the time range to view events from. In ISO 8601 format.",
    )
    time_max: Optional[str] = Field(
        None,
        title="Time Max",
        description="The end time of the time range to view events from. In ISO 8601 format.",
    )
